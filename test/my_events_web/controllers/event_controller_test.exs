defmodule MyEventsWeb.EventControllerTest do
  use MyEventsWeb.ConnCase

  alias MyEvents.EventManager

  @create_attrs %{city: "some city", description: "some description", event_date: ~D[2010-04-17], location: "some location", name: "some name"}
